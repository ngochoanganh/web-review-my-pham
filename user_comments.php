...
?>
   ...
   <form action="" method="POST">
      ...
      <div class="inline-option-btn" onclick="window.location.href = 'user_comments.php';">Hủy thay đổi</div>
   </form>
   </section>
<?php
   }
...
<section class="comments-container">
   ...
   <p class="comment-title">Bình luận của bạn tại bài viết này</p>
   <div class="user-comments-container">
      ...
      <div class="show-comments">
         ...
         ?>
         <div class="post-title"> Từ :<span><?= $fetch_posts['title']; ?></span> <a href="view_post.php?post_id=<?= $fetch_posts['id']; ?>" >Xem bài viết</a></div>
         <?php
            }
         ?>
