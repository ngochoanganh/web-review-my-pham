...
?>
   ...
   <form action="" method="POST">
      ...
      <textarea name="comment_edit_box" required cols="30" rows="10" placeholder="Bình luận tại đây"><?= $fetch_edit_comment['comment']; ?></textarea>
      <button type="submit" class="inline-btn" name="edit_comment">Chỉnh sửa</button>
      <div class="inline-option-btn" onclick="window.location.href = 'view_post.php?post_id=<?= $get_id; ?>';">Hủy thay đổi</div>
   </form>
   </section>
<?php
   }
...
<section class="comments-container">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment" maxlength="1000" class="comment-box" cols="30" rows="10" placeholder="Bình luận tại đây" required></textarea>
      ...
      <div class="show-comments" style="<?php if($fetch_comments['user_id'] == $user_id){echo 'order:-1;'; } ?>">
         <div class="comment-user">
            ...
            <div>
               ...
               <div><?= $fetch_comments['date']; ?>, <?= $fetch_comments['time']; ?></div>
         ...
         <form action="" method="POST">
            ...
            <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm('Xóa bình luận này?');">Xóa</button>
         </form>
         <?php
         }
         ?>
