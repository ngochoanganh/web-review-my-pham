...
<section class="authors">
   ...
   <div class="box">
      ...
      <p>Tổng số bài viết : <span><?= $total_admin_posts; ?></span></p>
      <p>Tổng số like : <span><?= $total_admin_likes; ?></span></p>
      <p>Tổng số bình luận : <span><?= $total_admin_comments; ?></span></p>
      <a href="author_posts.php?author=<?= $fetch_authors['name']; ?>" class="btn">Xem bài viết</a>
   </div>
   <?php
      }
   }else{
