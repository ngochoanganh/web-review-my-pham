...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="status" class="box" required>
         ...
         <option value="deactive">Tắt</option>
      </select>
      <p>Tiêu đề bài viết <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="Thêm tiêu đề" class="box" value="<?= $fetch_posts['title']; ?>">
      <p>Mô tả <span>*</span></p>
      <textarea name="content" class="box" required maxlength="10000" placeholder="Viết mô tả" cols="30" rows="10"><?= $fetch_posts['content']; ?></textarea>
   ...
   <?php
         ...
         echo '<p class="empty">Chưa có bài viêt nào được thêm!</p>';
   ?>
   <div class="flex-btn">
