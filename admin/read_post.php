...
<section class="read-post">
   ...
   <form method="post">
      ...
      <div class="flex-btn">
         ...
         <button type="submit" name="delete" class="inline-delete-btn" onclick="return confirm('Xóa bài viết này?');">Xóa</button>
         <a href="view_posts.php" class="inline-option-btn">Trở lại</a>
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">Chưa có bài viết được thêm! <a href="add_posts.php" class="btn" style="margin-top:1.5rem;">Thêm bài viết</a></p>';
      }
   ?>
