...
<section class="dashboard">
   ...
   <div class="box">
      ...
      <p>posts added</p>
      <a href="add_posts.php" class="btn">Thêm bài viết</a>
   </div>
   ...
   <div class="box">
      ...
      <p>Tài khoản user</p>
      <a href="users_accounts.php" class="btn">Xem user</a>
   </div>
   ...
   <div class="box">
      ...
      <h3><?= $numbers_of_admins; ?></h3>
      <p>Tài khoản đã nạp tiền</p>
      <a href="thongtin_tien.php" class="btn">Số tài khoản</a>
   </div>
